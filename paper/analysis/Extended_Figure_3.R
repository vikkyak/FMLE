...
# ==============================================================================
# CD7 Extended figure 3 cross donor NS1
# ==============================================================================
# donor NS1
...
p3_left_4T <- ggplot(cd4_df, aes(UMAP_1, UMAP_2, color = score)) +
  ...
  theme_classic(base_size = 8) +
  labs(
    title = "CD4\u207a T cells: IFN-\u03b3/cytokine\n associated\u2013biosynthetic axis",
    subtitle = "PBMC, test cells",
    x = "UMAP 1",
    y = "UMAP 2"
  ) +
...
p3_right_4T <- ggplot(pathway_df_4T, aes(x = NES, y = pathway)) +
  ...
  labs(
    x        = "Test-donor NS1",
    y        = NULL,
    title = "Reproducible CD4\u207a T IFN-associated\nand biosynthetic pathway shifts",
    subtitle = "Concordant in train donor and test donor; \nbars show test donor NS1"
  ) +
  theme(
    plot.title   = element_text(face = "bold"),
...
ggsave(file.path(out_dir, "Extended_Figure_3.pdf"),
       plot = fig,
       device = cairo_pdf,
